...
logo redrawn heavier for 32x32 — a grid of resources with one knocked out of its
slot — so a step in the run reads as the same thing as the tab, and the installer
